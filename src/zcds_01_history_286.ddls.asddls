...
association [1..1] to zdt_status_286 as _Status on _Status.status_code = $projection.PreviousStatus
association [1..1] to zdt_status_286 as _StatusNew on _StatusNew.status_code = $projection.NewStatus
